...
def get_player_page_url_list():
    #投手
    #endpoint = 'https://www.softbankhawks.co.jp/team/player/list/pitcher/index.html'
    #捕手
    #endpoint = 'https://www.softbankhawks.co.jp/team/player/list/catcher/index.html'
    #内野手
    #endpoint = 'https://www.softbankhawks.co.jp/team/player/list/infielder/index.html'
    #外野手
    endpoint = 'https://www.softbankhawks.co.jp/team/player/list/outfielder/index.html'
    ...
    url_list = []
    #選手の詳細ページのURLを抜き取る
    for ul_tag in html.find_all("ul", attrs={"class":"pl_boxColumn3"}):
    ...
    for div_tag in html.find_all("div", attrs={"class":"pl_imgBLock03"}): 
        for img_tag in div_tag.find_all("img"): 
            ...
            if url != None and url.find(".jpg") != -1:
                url = "https://www.softbankhawks.co.jp" + url
                return url 
            else:
                return []
...
def get_image_name(img_url):
    img_name = re.search(r'https://www.softbankhawks.co.jp/cmn/images/player/2018/(.+).jpg', img_url)
...
def convert_to_dic(player_data, file_name):
    #辞書を準備
    player_dic = {}
    key_list = ["name", "hurigana", "birthday", "age", "height", "weight", "home", "pb"]
