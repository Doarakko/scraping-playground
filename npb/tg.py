...
def get_player_page_url_list():
    #投手
    #endpoint = 'https://www.rakuteneagles.jp/team/player/list/pitcher/index.html'
    #捕手
    #endpoint = 'https://www.rakuteneagles.jp/team/player/list/catcher/index.html'
    #内野手
    #endpoint = 'https://www.rakuteneagles.jp/team/player/list/infielder/index.html'
    #外野手
    endpoint = 'https://www.rakuteneagles.jp/team/player/list/outfielder/index.html'
    ...
    for li_tag in html.find_all("ul", attrs={"class":"pl_boxColumn3"}):
        for a_tag in li_tag.find_all("a"):
            url = a_tag.get("href")
            url_list.append("https://www.rakuteneagles.jp" + url)
    #デバック
    ...
    for div_tag in html.find_all("div", attrs={"class":"pl_imgBLock03"}): 
        for img_tag in div_tag.find_all("img"): 
            ...
            if url != None and url.find(".jpg") != -1:
                url = "https://www.rakuteneagles.jp" + url
                return url 
            else:
                return []
...
def get_image_name(img_url):
    if img_url.find("2017") != -1:
        img_name = re.search(r'https://www.rakuteneagles.jp/cmn/images/player/2017/(.+).jpg', img_url)
    elif img_url.find("2018") != -1:
        img_name = re.search(r'https://www.rakuteneagles.jp/cmn/images/player/2018/(.+).jpg', img_url)
    else:
        return -1
